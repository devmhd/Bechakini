...
public class FakeHomeActivity extends ActionBarActivity {
    ...
    void logout(){
        ...
        startActivity(new Intent(FakeHomeActivity.this, LoginActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_fake_home, menu);
        return true;
    }
